...
def load_video(video_file, duration, target_fps=None, max_num_frames=None):
    import av
    import numpy as np
...
class LongVideoBenchDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"frames": frames, "inputs": inputs, "correct_choice": chr(ord("A")+di.get("correct_choice", -1)), **di}
